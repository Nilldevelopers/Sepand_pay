...
!function (e) {
    ...
    function t(n) {
        data_overlay(), function () {
        ...
        }(), SliderProject(), slick_client(i), function (n) {
            ...
            return {
                main_root: e("main.main-root"), ajax_click: e("a.effect-ajax "), isEffectAjax: function () {
                    ...
                    let a = this, i = e(".nav-work-img-box img.dsn-active").first(), s = n;
                    ...
                    var n = this, s = e('<div class="class-ajax-loader"></div>');
                    s.css({
                        position: "fixed",
                        left: 0,
                        top: 0,
                    ...
                    i.scrollTop() < r && TweenMax.fromTo(this.main_root, 1, {y: 0}, {
                        y: -150,
                        ease: Expo.easeIn
                    }), TweenMax.to(s, 1, {
                    ...
                    TweenMax.staggerTo(e(s.animateTextAjax), 1, {autoAlpha: 1, y: 0}, .2)
                }, loader: function (t, n) {
                    var a = this;
                    ...
                    return new Swiper(".dsn-slider .slide-inner", {
                        ...
                        pagination: {
                            ...
                            renderCustom: function (e, t, n) {
                                return dsnGrid.numberText($.persianNumbers(t))
                            }
                        },
                        on: {
                            init: function () {
    ...
    function n() {
        ...
        let n = 0;
        var a = e(".wrapper").offset(), o = e(".header-single-post .container").offset(),
            s = e(".post-full-content").offset(), l = 0;
    ...
    (navigator.userAgent.match(/Edge/i) || navigator.userAgent.match(/MSIE 10/i) || navigator.userAgent.match(/MSIE 9/i)) && e(".cursor").css("display", "none"), function () {
        var t = e(".preloader"), n = t.find(".preloader-block"), a = n.find(".percent"), o = n.find(".title"),
        ...
        i.on("load", function () {
            clearInterval(u), TweenMax.fromTo(l, .75, {width: "95%"}, {
                width: "100%", onUpdate: function () {
                    var e = l.width() / l.parent().width() * 100;
                    a.text($.persianNumbers(parseInt(e, 10)))
                }, onComplete: function () {
                    TweenMax.to(r, .75, {left: "100%"}), TweenMax.to(o, 1, {
                        autoAlpha: 0,
                        y: -100
                    }), TweenMax.to(s, 1, {
                        autoAlpha: 0,
                        y: 100
                    }), TweenMax.to(a, 1, {autoAlpha: 0}), TweenMax.to(c, 1, {
                        y: "-100%",
                        delay: .7
                    }), TweenMax.to(d, 1, {
                        y: "100%", delay: 1.0, onComplete: function () {
                            t.addClass("hidden")
                        }
                    })
                }
        ...
        e(".site-header .custom-drop-down > a").on("click", function () {
            ...
            var t = i.scrollTop(), n = e(".site-header , .header-top"), a = e(".page-content").offset(), o = 70;
        ...
        if (!(n.length <= 0)) {
            var a = n.find(".text-button"), s = n.find(".text-open"), r = n.find(".text-close");
            dsnGrid.convertTextWord(a, a, !0), dsnGrid.convertTextWord(s, s, !0), dsnGrid.convertTextWord(r, r, !0)
        }
    }();
    var r = a(), l = function () {
        var t = new ScrollMagic.Controller;
        const n = '[data-dsn-header="project"]', a = '[data-dsn-footer="project"]';
        return {
            clearControl: function () {
                ...
                let a = e("#dsn-hero-parallax-img"), i = e("#dsn-hero-parallax-title"),
                ...
                let n = e("#dsn-next-parallax-img"), i = e("#dsn-next-parallax-title"),
